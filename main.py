...
def main():
    pygame.init()
    tela = (800, 600)
    pygame.display.set_mode(tela, pygame.DOUBLEBUF | pygame.OPENGL)
    ...
    while True:
        ...
        desenhar_jogo(jogo, celula_selecionada, estrelas, asteroides, camera)  # Adicionado 'camera' como argumento

        # Desenhar a mira
        superficie = pygame.display.get_surface()
        superficie.fill((255, 255, 255, 0))
        desenhar_mira(superficie)
